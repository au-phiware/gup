...
use crate::{
    CrossFadeComposition, CustomCompositionBehavior, GupResult, LayoutDirection, 
    Mixable, MixableExt, RenderContext, SideBySideConfig
};
use std::sync::Arc;
...
pub mod composition_examples {
    ...
    pub fn cross_fade_example() -> impl Mixable<Output = ()> {
        ...
        let behavior = CustomCompositionBehavior::CrossFade(CrossFadeComposition {
            fade_factor: 0.7,
        });
