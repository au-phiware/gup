...
| [GUP-234](GUP-234_Adaptive_Build_Coverage_Budget.md)           | Adaptive Build Coverage Cell Budget            | ✅ Complete | Low      | —      |
...
| [GUP-054](GUP-054_Shader_Function_Performance_Optimization.md) | Shader Function Performance Optimization | ✅ Complete | Medium   | 5      |
...
| Story                                                         | Title                                     | Status      | Priority | Points |
| ------------------------------------------------------------- | ----------------------------------------- | ----------- | -------- | ------ |
| [GUP-054](GUP-054_Existing_Solutions_Analysis.md)             | Existing Solutions Analysis               | ✅ Complete | High     | 8      |
...
| [GUP-060](GUP-060_Optimization_Error_Reporting.md)            | Optimization Engine and Error Reporting   | ✅ Complete | Medium   | 13     |
...
| [GUP-213](GUP-213_Transpiler_Custom_Struct_Support.md)        | Transpiler Custom Struct Support          | ✅ Complete | Low      | 5      |
...
| [GUP-220](GUP-220_Mixed_Chain_Attribute_Deduplication.md)    | Mixed Chain Attribute Deduplication      | ✅ Complete | Low      | 3      |
| [GUP-221](GUP-221_Pool_Aware_SetData_Selection.md)           | Pool-Aware set_data for Selection        | ✅ Complete | Low      | 2      |
...
| [GUP-235](GUP-235_Radix_Sort_Scatter_Optimization.md)      | Radix Sort Scatter Optimization       | ✅ Complete | Low      | —      |
| [GUP-236](GUP-236_Sort_Aware_Visual_Demo.md)               | Sort-Aware Visual Demo                | ✅ Complete | Low      | —      |
...
| [GUP-243](GUP-243_Puppeteer_HTML_Benchmark_CI_Runner.md)         | Puppeteer HTML Benchmark CI Runner          | 🚧 In Progress | Low      | 3      |
...
| [GUP-242](GUP-242_Shared_UI_Chrome_Renderer.md)                                    | Shared UI Chrome Renderer                   | ✅ Complete | Low      | 5      |
...
- **Status**: 🚧 In Progress — core stories done, rendering integration complete
- **Core stories complete**: GUP-001 ✅, GUP-002 ✅, GUP-003 ✅, GUP-004 ✅,
  ...
  GUP-088 ✅, GUP-149 ✅, GUP-165 ✅, GUP-166 ✅
- **Rendering integration chain**: GUP-165 ✅ → GUP-149 ✅ / GUP-166 ✅ —
  complete; box plots render via unified SDF shader in single draw call
...
Integration) when investigation revealed that the Selection API had no rendering
capabilities. GUP-165 and GUP-166 were completed to unblock GUP-149; the story
is now ✅ Complete.

### GUP-165: Selection API Render Integration

**Status**: ✅ Complete **Priority**: High **Story Points**: 13 **Key Need**:
The Selection API (GUP-002) handles data binding and events but provides no
render pipeline creation, buffer management, bind group setup, or draw call
...
| Selection API Parallel Output Integration | ✅ Complete | Medium | 8 |
