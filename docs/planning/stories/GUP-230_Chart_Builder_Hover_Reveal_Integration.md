...
- [ ] Hover reveal can be enabled/disabled via a chart builder configuration
      option
- [ ] `TooltipConfig` can be customized through the chart builder API
...
- [ ] Chart builder automatically supports hover reveal
- [ ] Configuration via builder API
- [ ] Tests passing
- [ ] Example demonstrating automatic hover reveal in a chart
