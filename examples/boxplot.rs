    ...
    let datasets = vec![
        (
            ...
            vec![
                ...
                54.0, 56.0, 58.0, 60.0, 50.0, 52.0, 45.0, 47.0, 49.0, 51.0, 53.0, 55.0, 57.0, 59.0,
                61.0, 48.0,
            ],
        ),
        (
            ...
            vec![
                ...
                69.0, 71.0, 76.0, 82.0, 88.0, 95.0, 62.0, 64.0, 66.0, 68.0, 70.0, 73.0, 78.0, 84.0,
                90.0, 65.0,
            ],
        ),
        (
            ...
            vec![
                ...
                52.0, 57.0, 62.0, 67.0, 69.0, 34.0, 36.0, 39.0, 44.0, 49.0, 54.0, 59.0, 64.0, 68.0,
                70.0, 38.0,
            ],
        ),
        (
            ...
            vec![
                ...
                47.0, 48.0, 49.0, 50.0, 51.0, 52.0, // Add outliers
